...
function defaultTooltipFormatter(json, rowData, config) {
  ...
  _lodash2.default.each(tooltipFields, function (key) {
    ...
    var tipDotStyle = _lodash2.default.assign({ background: series.color }, _style2.default.DOT);
    html += '\n    <li>\n      <span style="float: right">' + value + '</span>\n      <span style=' + tipDotStyle + '></span>\n      ' + series.name + ':\n    </li>\n    ';
  });

  return '\n    <h5 style=' + _style2.default.TIP_TITLE + '>' + this.x + '</h5>\n    <div style=' + _style2.default.TIP_CONTENT + '>\n      <ul style=' + _style2.default.TIP_LIST + '>' + html + '</ul>\n    </div>\n  ';
}
